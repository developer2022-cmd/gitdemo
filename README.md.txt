This Project is illustrate following task:-

Checklist of the tasks that are required to be performed: 

Create a Repro as Manager in Github:-
...
git config --global user.email "2019ht66559@gmail.com"

git config --local user.name "developer2022-cmd"

git config --local user.email "2019ht66559@gmail.com"
